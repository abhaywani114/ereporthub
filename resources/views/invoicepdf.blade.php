...
$data = json_decode($report->details,true);
@endphp
...
<hr style="border: 1px solid #eee;clear:both;" />
	...
	<div>
    <h6 style="padding-bottom: 0;margin-bottom: 0;word-spacing: 6px;font-weight: 500;   font-family: 'Inconsolata', monospace;"><small>Report Name:</small> {{$report->report_name}} | <small>Date:</small> {{date('d F Y',strtotime($report->created_at))}}</h6>
	...
	<table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong>{{$report->cost}}</strong></td>
                    </tr>
                </tbody>
            </table>    
...
<div class="bottom">
    ...
    <h6>Bill Generated By: eReport Hub</h6>
  </div>
</div>
</div>
