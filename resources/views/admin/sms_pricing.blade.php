...
@section('title','Add SMS Credit - eReportHub')
@php
...
<div class="cointainer " style="margin: 8vh auto;;">
    ...
    <div class="pad_30">
        <h1 class="hdg hdg_1 hdg_title">Add SMS Credit</h1><br/>
          @if (session('status'))
                    <br/>
                                    ...
                                    <div class="col-lg-6 col-sm-12" style="margin: auto;">
                                        <div class="pricingTable">
                                            ...
                                            <ul class="pricing-content">
                                                <li>xxx sms credit</li>
                                                <li>Local</li>

                                            </ul>
                                            <a href="/pay/sms/basic" class="pricingTable-signup" disabled>Proceed To Pay</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-12" style="margin: auto;">
                                        <div class="pricingTable pink">
                                            ...
                                            <a href="/pay/sms/PREMIUM" class="pricingTable-signup" disabled>Proceed To Pay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
