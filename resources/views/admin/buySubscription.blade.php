...
@section('title','Buy Subscription - eReportHub')
@php
...
<div class="cointainer " style="margin: 8vh auto;;">
    ...
    <div class="pad_30">
        <h1 class="hdg hdg_1 hdg_title">Buy Subscription</h1><br/>
          @if (session('status'))
                    <br/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12" style="margin: auto;">
                                        <div class="pricingTable">
                                            ...
                                            <ul class="pricing-content">
                                                <li>xxx free sms credit</li>
                                                <li>Local</li>

                                            </ul>
                                            <a href="/pay/subscription/basic" class="pricingTable-signup">Proceed to Pay</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12" style="margin: auto;">
                                        <div class="pricingTable pink">
                                            ...
                                            <a href="/pay/subscription/BI_ANUALLY" class="pricingTable-signup">Proceed to Pay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
